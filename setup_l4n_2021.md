...
<details>
    <summary>A. チュートリアル用Lin4Neuro仮想アプライアンスのダウンロード (所要時間約2-3時間) (第8回受講者はスキップ)</summary>
...
<details>
    <summary>B. VirtualBox 6.1.16以降 のインストール (所要時間約10分) (第8回受講者はスキップ)</summary>
...
<details>
    <summary>C. Lin4Neuro仮想アプライアンスのインポート (所要時間約15分) (第8回受講者はスキップ)</summary>
...
<details>
    <summary>D. 仮想マシンの設定 (所要時間約5分) (第8回受講者はスキップ)</summary>
...
<details>
    <summary>E. Lin4Neuroの起動と設定 (所要時間約10分) (第8回受講者はスキップ)</summary>
...
<details>
    <summary>F. チュートリアルテキストの入手 (所要時間約3分)</summary>
...
<details>
    <summary>G. データの入手 (所要時間約30-60分)</summary>
...
<details>
    <summary>H. 受講のためのスクリプトを実行 (所要時間約15分)</summary>
...
<details>
    <summary>参考. 仮想マシンの削除 (チュートリアル後、不要になった場合)</summary>
...
<details>
    <summary>これまでに問い合わせをいただいた内容とその対策を紹介します</summary>
...
- Q2. Lin4Neuroをアップデートした際、ログイン画面が下図のように背景が真っ黒になってしまいました。どうすればよろしいですか？
   ...
   - A2. これは、システムアップデートによりログイン画面の設定がリセットされてしまうことによります。以下で解決できます
    ...
    ```
        ...
        - パスワードは `lin4neuro` です。再起動するとログイン画面が元に戻ります
